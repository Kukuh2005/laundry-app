            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="basic-default-name" name="telepon"
                        value="{{$pelanggan->telepon}}" oninput="validasiInput(this)" placeholder="Contoh: 0878****">
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-email">Alamat</label>
                <div class="col-sm-10">
                    <textarea id="basic-default-message" class="form-control" name="alamat"
                        placeholder="Nama jalan, Rt, Rw, No rumah">{{$pelanggan->alamat}}</textarea>
                </div>
            </div>
