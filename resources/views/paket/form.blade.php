    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/{{auth()->user()->level}}/paket/store" method="POST">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" name="durasi" oninput="validasiInput(this)" placeholder="Contoh: 24, 48, 72">
                        </div>
                    </div>
                    <div class="row mb-3">
